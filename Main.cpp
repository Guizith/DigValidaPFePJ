...
milliseconds tmphalfcpf1;	//Variavel de armazenamento do tempo de execucao da thread halfcpf1
milliseconds tmphalfcpf2;	//Variavel de armazenamento do tempo de execucao da thread halfcpf2
...
void prints(){
	...
	cout << "O tempo de excucao do calculo dos digitos na Thread halfcpf1 foi de: "<< tmphalfcpf1.count() << " m/s"<<endl;
	cout << "O tempo de excucao do calculo dos digitos na Thread halfcpf2 foi de: "<< tmphalfcpf2.count() << " m/s"<<endl;
	cout << "O tempo de excucao do calculo dos digitos na Thread halfcnpj1 foi de: "<< tmphalfcnpj1.count() << " m/s"<<endl;
	cout << "O tempo de excucao do calculo dos digitos na Thread halfcnpj2 foi de: "<< tmphalfcnpj2.count() << " m/s"<<endl;
	cout << "O tempo de excucao do calculo dos digitos no total foi de: "<< tmpclc.count() << " m/s"<<endl;
	
	fprintf(sc,"Total de linhas lidas: %d \n",(ctrlcpfs+ctrlcnpjs));
	fprintf(sc,"Total de CPFs: %d \n",ctrlcpfs);
	fprintf(sc,"Total de CNPJs: %d \n",ctrlcnpjs);
	fprintf(sc,"O tempo de excucao da leitura da base de dados foi de : %d m/s \n",tmple.count());
	fprintf(sc,"O tempo de excucao do calculo dos digitos na Thread halfcpf1 foi de: %d m/s \n", tmphalfcpf1.count());
	fprintf(sc,"O tempo de excucao do calculo dos digitos na Thread halfcpf2 foi de: %d m/s \n", tmphalfcpf2.count());
